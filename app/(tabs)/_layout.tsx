...
export default function TabLayout() {
  // Keep the tab navigator on the stable Expo Router Tabs implementation.
  // The experimental native-tabs/liquid-glass path can crash on Android
  // during navigation even when the app itself is otherwise valid.
